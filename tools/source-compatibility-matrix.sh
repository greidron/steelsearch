...
action_status() {
  ...
  case "${action}" in
    PutMappingAction.INSTANCE|AutoPutMappingAction.INSTANCE|IndicesAliasesAction.INSTANCE|UpdateSettingsAction.INSTANCE|AnalyzeAction.INSTANCE|CreateIndexAction.INSTANCE|AutoCreateAction.INSTANCE|DeleteIndexAction.INSTANCE)
      echo "implemented"
      return
      ;;
  esac
