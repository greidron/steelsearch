...
route_status() {
  ...
  case "${method} ${path}" in
    ...
    "GET /_cluster/health"|"PUT /{index}"|"GET /{index}"|"DELETE /{index}"|"PUT /{index}/_doc/{id}"|"GET /{index}/_doc/{id}")
      echo "stubbed"
      ;;
    "GET /_segments"|"GET /{index}/_segments"|"GET /_recovery"|"GET /{index}/_recovery"|"GET /_field_caps"|"POST /_field_caps"|"GET /{index}/_field_caps"|"POST /{index}/_field_caps"|"GET /_refresh"|"POST /_refresh"|"GET /{index}/_refresh"|"POST /{index}/_refresh"|"GET /_count"|"POST /_count"|"GET /{index}/_count"|"POST /{index}/_count"|"GET /_mget"|"POST /_mget"|"GET /{index}/_mget"|"POST /{index}/_mget"|"GET /_mtermvectors"|"POST /_mtermvectors"|"GET /{index}/_mtermvectors"|"POST /{index}/_mtermvectors"|"GET /{index}/_termvectors"|"POST /{index}/_termvectors"|"GET /{index}/_termvectors/{id}"|"POST /{index}/_termvectors/{id}"|"GET /_search/scroll"|"POST /_search/scroll"|"GET /_search/scroll/{scroll_id}"|"POST /_search/scroll/{scroll_id}"|"DELETE /_search/scroll"|"DELETE /_search/scroll/{scroll_id}"|"POST /{index}/_search/point_in_time"|"DELETE /_search/point_in_time"|"DELETE /_search/point_in_time/_all"|"GET /_search/point_in_time/_all"|"GET /_cat/pit_segments"|"GET /_cat/pit_segments/_all"|"GET /_list"|"GET /_list/indices"|"GET /_list/indices/{index}"|"GET /_list/shards"|"GET /_list/shards/{index}")
      echo "implemented"
      ;;
    *)
      echo "planned"
