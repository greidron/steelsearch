...
search_registration_status() {
  ...
  case "${category}" in
    ...
    aggregation)
      case "${text}" in
        *RareTermsAggregationBuilder.NAME*|*AutoDateHistogramAggregationBuilder.NAME*|*VariableWidthHistogramAggregationBuilder.NAME*|*MultiTermsAggregationBuilder.NAME*)
          echo "planned"
          return
          ;;
