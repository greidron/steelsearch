...
action_status() {
  ...
  if [[ "${source}" == "${KNN_ROOT}"/* ]]; then
    case "${action}" in
      KNNStatsAction.INSTANCE|KNNWarmupAction.INSTANCE|ClearCacheAction.INSTANCE|RemoveModelFromCacheAction.INSTANCE)
        echo "implemented"
        ;;
      UpdateModelMetadataAction.INSTANCE|TrainingJobRouteDecisionInfoAction.INSTANCE|GetModelAction.INSTANCE|DeleteModelAction.INSTANCE|TrainingJobRouterAction.INSTANCE|TrainingModelAction.INSTANCE|SearchModelAction.INSTANCE|UpdateModelGraveyardAction.INSTANCE)
        echo "partial"
        ;;
      *)
        echo "planned"
  ...
  case "${action}" in
    PutMappingAction.INSTANCE|AutoPutMappingAction.INSTANCE|IndicesAliasesAction.INSTANCE|UpdateSettingsAction.INSTANCE|ScaleIndexAction.INSTANCE|AnalyzeAction.INSTANCE|CreateIndexAction.INSTANCE|AutoCreateAction.INSTANCE|ResizeAction.INSTANCE|RolloverAction.INSTANCE|DeleteIndexAction.INSTANCE|OpenIndexAction.INSTANCE|CloseIndexAction.INSTANCE|AddIndexBlockAction.INSTANCE|SimulateIndexTemplateAction.INSTANCE|SimulateTemplateAction.INSTANCE)
      echo "implemented"
      return
      ;;
  esac
  ...
  case "${action}" in
    MainAction.INSTANCE|NodesInfoAction.INSTANCE|RemoteInfoAction.INSTANCE|NodesStatsAction.INSTANCE|WlmStatsAction.INSTANCE|NodesUsageAction.INSTANCE|NodesHotThreadsAction.INSTANCE|NodesReloadSecureSettingsAction.INSTANCE|ListTasksAction.INSTANCE|GetTaskAction.INSTANCE|CancelTasksAction.INSTANCE|ClusterStateAction.INSTANCE|GetTermVersionAction.INSTANCE|ClusterHealthAction.INSTANCE|ClusterUpdateSettingsAction.INSTANCE|ClusterSearchShardsAction.INSTANCE|PendingClusterTasksAction.INSTANCE|ClusterAllocationExplainAction.INSTANCE|RemoteStoreStatsAction.INSTANCE|PutRepositoryAction.INSTANCE|GetRepositoriesAction.INSTANCE|DeleteRepositoryAction.INSTANCE|VerifyRepositoryAction.INSTANCE|CleanupRepositoryAction.INSTANCE|GetSnapshotsAction.INSTANCE|DeleteSnapshotAction.INSTANCE|CreateSnapshotAction.INSTANCE|CloneSnapshotAction.INSTANCE|RestoreSnapshotAction.INSTANCE|SnapshotsStatusAction.INSTANCE|IndicesStatsAction.INSTANCE|ClusterStatsAction.INSTANCE|CatShardsAction.INSTANCE|IndicesSegmentsAction.INSTANCE|IndicesShardStoresAction.INSTANCE|GetMappingsAction.INSTANCE|GetFieldMappingsAction.INSTANCE|RefreshAction.INSTANCE|GetAliasesAction.INSTANCE|GetSettingsAction.INSTANCE|IndexAction.INSTANCE|GetAction.INSTANCE|DeleteAction.INSTANCE|UpdateAction.INSTANCE|MultiGetAction.INSTANCE|BulkAction.INSTANCE|ClearScrollAction.INSTANCE|RecoveryAction.INSTANCE|SegmentReplicationStatsAction.INSTANCE|GetDataStreamAction.INSTANCE|DataStreamsStatsAction.INSTANCE|CreateViewAction.INSTANCE|DeleteViewAction.INSTANCE|GetViewAction.INSTANCE|UpdateViewAction.INSTANCE|ListViewNamesAction.INSTANCE|SearchViewAction.INSTANCE|ListDanglingIndicesAction.INSTANCE|ImportDanglingIndexAction.INSTANCE|DeleteDanglingIndexAction.INSTANCE|FindDanglingIndexAction.INSTANCE|CreatePitAction.INSTANCE|DeletePitAction.INSTANCE|PitSegmentsAction.INSTANCE|GetAllPitsAction.INSTANCE|FieldCapabilitiesAction.INSTANCE|GetPipelineAction.INSTANCE|GetSearchPipelineAction.INSTANCE|DeleteSearchPipelineAction.INSTANCE|RemoteStoreMetadataAction.INSTANCE|ExtensionProxyAction.INSTANCE|PruneFileCacheAction.INSTANCE|AddVotingConfigExclusionsAction.INSTANCE|ClearVotingConfigExclusionsAction.INSTANCE|ClusterAddWeightedRoutingAction.INSTANCE|ClusterGetWeightedRoutingAction.INSTANCE|ClusterDeleteWeightedRoutingAction.INSTANCE|DecommissionAction.INSTANCE|GetDecommissionStateAction.INSTANCE|DeleteDecommissionStateAction.INSTANCE|ListTieringStatusAction.INSTANCE|GetTieringStatusAction.INSTANCE|UpgradeSettingsAction.INSTANCE|PauseIngestionAction.INSTANCE|ResumeIngestionAction.INSTANCE|GetIngestionStateAction.INSTANCE|UpdateIngestionStateAction.INSTANCE|UpdatePersistentTaskStatusAction.INSTANCE|RemovePersistentTaskAction.INSTANCE|CompletionPersistentTaskAction.INSTANCE|RetentionLeaseActions.Add.INSTANCE|RetentionLeaseActions.Renew.INSTANCE|RetentionLeaseActions.Remove.INSTANCE|TermVectorsAction.INSTANCE|MultiTermVectorsAction.INSTANCE)
      echo "implemented"
      ;;
    ClusterRerouteAction.INSTANCE|GetIndexAction.INSTANCE|IndicesExistsAction.INSTANCE|PutIndexTemplateAction.INSTANCE|GetIndexTemplatesAction.INSTANCE|DeleteIndexTemplateAction.INSTANCE|PutComponentTemplateAction.INSTANCE|GetComponentTemplateAction.INSTANCE|DeleteComponentTemplateAction.INSTANCE|GetComposableIndexTemplateAction.INSTANCE|DeleteComposableIndexTemplateAction.INSTANCE|ValidateQueryAction.INSTANCE|FlushAction.INSTANCE|ForceMergeAction.INSTANCE|UpgradeAction.INSTANCE|UpgradeStatusAction.INSTANCE|ClearIndicesCacheAction.INSTANCE|SearchAction.INSTANCE|StreamSearchAction.INSTANCE|MultiSearchAction.INSTANCE|ExplainAction.INSTANCE|GetStoredScriptAction.INSTANCE|GetScriptContextAction.INSTANCE|GetScriptLanguageAction.INSTANCE|CreateDataStreamAction.INSTANCE|DeleteDataStreamAction.INSTANCE|ResolveIndexAction.INSTANCE|StartPersistentTaskAction.INSTANCE|RestoreRemoteStoreAction.INSTANCE)
      echo "partial"
      ;;
    *)
      echo "planned"
