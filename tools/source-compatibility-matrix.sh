...
action_status() {
  ...
  case "${action}" in
    PutMappingAction.INSTANCE|AutoPutMappingAction.INSTANCE|IndicesAliasesAction.INSTANCE|UpdateSettingsAction.INSTANCE|ScaleIndexAction.INSTANCE|AnalyzeAction.INSTANCE|CreateIndexAction.INSTANCE|AutoCreateAction.INSTANCE|RolloverAction.INSTANCE|DeleteIndexAction.INSTANCE|OpenIndexAction.INSTANCE|CloseIndexAction.INSTANCE|AddIndexBlockAction.INSTANCE|SimulateIndexTemplateAction.INSTANCE|SimulateTemplateAction.INSTANCE)
      echo "implemented"
      return
      ;;
  esac
