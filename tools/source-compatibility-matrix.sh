...
action_status() {
  ...
  case "${action}" in
    PutMappingAction.INSTANCE|IndicesAliasesAction.INSTANCE|UpdateSettingsAction.INSTANCE)
      echo "implemented"
      return
      ;;
  esac
