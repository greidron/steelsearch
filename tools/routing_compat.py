#!/usr/bin/env python3
"""Run custom-routing HTTP compatibility checks against Steelsearch and OpenSearch."""
...
DEFAULT_FIXTURE = ROOT / "tools" / "fixtures" / "routing-compat.json"
DEFAULT_OUTPUT = ROOT / "target" / "routing-compat-report.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        default=os.environ.get("ROUTING_COMPAT_REPORT", str(DEFAULT_OUTPUT)),
    )
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        "name": fixture.get("name", "routing-compat"),
