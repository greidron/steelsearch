...
def main():
    if len(sys.argv) < 2:
        raise SystemExit('usage: check_broader_restore_family_practical_stop.py REPORT...')
    ...
    result = 'inconclusive'
    if all_unformed and all_no_followup:
        result = 'broader_launch_env_restore_family_reached_practical_stop_without_restoring_followup_or_formed_handoff'
