#!/usr/bin/env python3
"""Run allocation-explain HTTP compatibility checks against Steelsearch and OpenSearch."""
...
DEFAULT_FIXTURE = ROOT / "tools" / "fixtures" / "allocation-explain-compat.json"
DEFAULT_OUTPUT = ROOT / "target" / "allocation-explain-compat-report.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        default=os.environ.get("ALLOCATION_EXPLAIN_COMPAT_REPORT", str(DEFAULT_OUTPUT)),
    )
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        "name": fixture.get("name", "allocation-explain-compat"),
