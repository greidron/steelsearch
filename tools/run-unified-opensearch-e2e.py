...
ADMIN_OPS_COMMON_CASES: tuple[str, ...] = (
    ...
    "admin_ops_closed_target_refresh_semantic",
    "admin_ops_closed_target_flush_semantic",
    "admin_ops_closed_target_cache_clear_semantic",
    "admin_ops_closed_target_forcemerge_semantic",
    "admin_ops_closed_wildcard_refresh_default_semantic",
    "admin_ops_closed_wildcard_flush_default_semantic",
    "admin_ops_closed_wildcard_cache_clear_default_semantic",
    "admin_ops_closed_wildcard_forcemerge_default_semantic",
    "admin_ops_closed_wildcard_refresh_all_semantic",
    "admin_ops_closed_wildcard_flush_all_semantic",
    "admin_ops_closed_wildcard_cache_clear_all_semantic",
    "admin_ops_closed_wildcard_forcemerge_all_semantic",
    "admin_ops_closed_global_segments_semantic",
    "admin_ops_closed_global_stats_semantic",
    "admin_ops_closed_global_upgrade_semantic",
    "admin_ops_closed_wildcard_segments_default_semantic",
    "admin_ops_closed_wildcard_stats_default_semantic",
    "admin_ops_closed_wildcard_upgrade_default_semantic",
    "admin_ops_closed_wildcard_segments_all_semantic",
    "admin_ops_closed_wildcard_stats_all_semantic",
    "admin_ops_closed_wildcard_upgrade_all_semantic",
    "admin_ops_closed_target_segments_semantic",
    "admin_ops_closed_target_stats_semantic",
    "admin_ops_closed_target_upgrade_semantic",
