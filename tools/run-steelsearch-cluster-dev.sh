...
SHARED_RUNTIME_STATE_PATH="${STEELSEARCH_SHARED_RUNTIME_STATE_PATH:-${WORK_DIR}/shared-runtime-state.json}"
PIDS=()
...
for ((i = 0; i < NODE_COUNT; i++)); do
  ...
  (
    ...
    export STEELSEARCH_SHARED_RUNTIME_STATE_PATH="${SHARED_RUNTIME_STATE_PATH}"
