...
class NodeRuntimeBoundaryContractsTests(unittest.TestCase):
    ...
    def test_current_node_runtime_partials_have_boundary_owner_mappings(self):
        ...
        self.assertEqual(result["summary"]["externally_matched_evidence_count"], 87)
        self.assertEqual(result["summary"]["self_referential_evidence_count"], 147)
        self.assertEqual(result["summary"]["externally_matched_boundary_count"], 31)
        self.assertEqual(result["summary"]["self_referential_boundary_count"], 47)
