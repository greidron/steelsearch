...
SOURCE_FILE="${CACHE_DIR}/BuildPrepareTranslogRequest.java"
CLASS_FILE="${CACHE_DIR}/BuildPrepareTranslogRequest.class"
...
public class BuildPrepareTranslogRequest {
...
java -cp "${LIB_CP}:${TMPDIR:-/tmp}/steelsearch-java-response-cache" org.opensearch.indices.recovery.BuildPrepareTranslogRequest \
