#!/usr/bin/env python3
"""Run cluster-settings HTTP compatibility checks against Steelsearch and OpenSearch."""
...
DEFAULT_FIXTURE = ROOT / "tools" / "fixtures" / "cluster-settings-compat.json"
DEFAULT_OUTPUT = ROOT / "target" / "cluster-settings-compat-report.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        default=os.environ.get("CLUSTER_SETTINGS_COMPAT_REPORT", str(DEFAULT_OUTPUT)),
    )
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        "name": fixture.get("name", "cluster-settings-compat"),
