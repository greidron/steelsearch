#!/usr/bin/env python3
"""Run refresh-route HTTP compatibility checks against Steelsearch and OpenSearch."""
...
DEFAULT_FIXTURE = ROOT / "tools" / "fixtures" / "refresh-compat.json"
DEFAULT_OUTPUT = ROOT / "target" / "refresh-compat-report.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        default=os.environ.get("REFRESH_COMPAT_REPORT", str(DEFAULT_OUTPUT)),
    )
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        "name": fixture.get("name", "refresh-compat"),
