...
def main() -> int:
    ...
    subprocess.run(TEST_CMD, cwd=ROOT, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, check=True)
    ...
    result = {
        ...
        "result": "workspace_cargo_test_no_run_graph_scanned_for_nonempty_unlocked_rmeta_units",
    }
