#!/usr/bin/env python3
"""Run index lifecycle HTTP compatibility checks against Steelsearch and OpenSearch."""
...
DEFAULT_FIXTURE = ROOT / "tools" / "fixtures" / "index-lifecycle-compat.json"
DEFAULT_OUTPUT = ROOT / "target" / "index-lifecycle-compat-report.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        default=os.environ.get("INDEX_LIFECYCLE_COMPAT_REPORT", str(DEFAULT_OUTPUT)),
    )
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        "name": fixture.get("name", "index-lifecycle-compat"),
