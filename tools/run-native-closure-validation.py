...
SOURCE_BACKED_QUERY_BATCH: tuple[ValidationTest, ...] = (
    ...
    ValidationTest(
        "native_nested_unsupported_leaf_uses_source_validation_fallback",
    ...
    ValidationTest(
        "rank_feature_non_feature_field_fallback_updates_materialized_telemetry",
        "source-backed-fallback-boundary",
    ),
    ValidationTest(
    ...
    ValidationTest(
        "more_like_this_fieldless_fallback_updates_materialized_telemetry",
        "source-backed-fallback-boundary",
    ),
    ValidationTest(
    ...
    ValidationTest(
        "terms_set_non_term_field_fallback_updates_materialized_telemetry",
        "source-backed-fallback-boundary",
    ),
    ValidationTest(
