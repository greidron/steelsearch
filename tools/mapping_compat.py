#!/usr/bin/env python3
"""Run mapping HTTP compatibility checks against Steelsearch and OpenSearch."""
...
DEFAULT_FIXTURE = ROOT / "tools" / "fixtures" / "mapping-compat.json"
DEFAULT_OUTPUT = ROOT / "target" / "mapping-compat-report.json"
...
def main() -> int:
    ...
    report: dict[str, Any] = {
        "name": fixture.get("name", "mapping-compat"),
