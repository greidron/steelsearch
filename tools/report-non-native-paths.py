...
FAMILIES: tuple[Family, ...] = (
    Family(
        ...
        status="native-candidate-narrowed for exact nested term/terms/terms_set/range/exists/geo_distance/distance_feature/rank_feature/prefix/wildcard/regexp/fuzzy/match/match_phrase/match_phrase_prefix/match_bool_prefix/combined_fields/multi_match/query_string/simple_query_string/more_like_this/dis_max/boosting/function_score/script_score/bool leaves",
        next_action="keep unsupported nested shapes on explicit fallback telemetry while using child-ordinal narrowing for the current safe scalar, geo-distance, distance-feature, rank-feature, terms-set, combined-fields, multi-match, query-string, simple-query-string, more-like-this, wrapper, score-wrapper, match, phrase, bool-prefix, and string-pattern leaves",
