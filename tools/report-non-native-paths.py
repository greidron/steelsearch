...
PROBES: tuple[Probe, ...] = (
    ...
    Probe(
        ...
        risk="must stay present so mixed movement keeps seq/checkpoint drift, monotonicity, and retention-lease metadata evidence, the interrupted/resumed phase contract, the enforceable gate option, and both live interruption exercises",
    ),
    Probe(
...
FAMILIES: tuple[Family, ...] = (
    ...
    Family(
        ...
        category="mixed-cluster",
        status="mixed-shard validation batch passed with both-direction live interruption exercises, zero checkpoint drift, checkpoint monotonicity, and retention-lease metadata",
        next_action="add allocation-explain coverage for unsupported movement shapes",
        evidence_path=NATIVE_CLOSURE_VALIDATION,
