...
FAMILIES: tuple[Family, ...] = (
    ...
    Family(
        ...
        next_action="run final benchmark, load, chaos, packaging, and rolling-upgrade evidence capture before production cutover, feed those artifacts through the release-readiness manifest writer, and validate the manifest with check-release-readiness-evidence.py --require-passed",
        evidence_path=NATIVE_CLOSURE_VALIDATION,
