...
FIXTURE="$ROOT_DIR/tools/fixtures/mixed-cluster-failure-profiles.json"
PROFILE=""
REPORT_DIR="$ROOT_DIR/target/mixed-cluster-failure"
PREPARE_CMD=""
TRIGGER_CMD=""
CHECK_CMD=""
...
usage() {
  cat <<'EOF'
Usage:
  tools/run-phase-c-gap-harness.sh --profile <name> [options]

Options:
  --fixture <path>       Profile fixture path
  --report-dir <dir>     Report root (default: target/mixed-cluster-failure)
