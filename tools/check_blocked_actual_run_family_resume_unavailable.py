...
def main() -> int:
    if len(sys.argv) != 3:
        print('usage: check_blocked_actual_run_family_resume_unavailable.py <top-level-blocked-json> <capability-frontier-json>')
        return 2
    ...
    if (
        ...
        result['checker_result'] = 'blocked_actual_run_family_cannot_be_resumed_because_no_new_capability_or_relief_candidate_is_currently_available'
    else:
        result['checker_result'] = 'blocked_actual_run_family_resume_status_incomplete'
