...
if base['membership_formed'] is False and cur['membership_formed'] is False and base['observed_node_count']==1 and cur['observed_node_count']==1 and base['follow_up_count']==0 and cur['follow_up_count']==0:
    result='aggressive_opensearch_ping_schedule_does_not_restore_followup_or_formed_handoff'
print(json.dumps({'baseline_java_only': base, 'current_java_only_ping': cur, 'checker_result': result}, indent=2))
