...
def main() -> int:
    ...
    lib_start_ms = round(os_node_lib["start"] * 1000, 2)
    ...
    overlap_count = sum(1 for unit in unlocked_rmeta if unit["starts_before_lib_finish"])
    result = {
        "os_node_lib_start_ms": lib_start_ms,
        ...
        "unlocked_rmeta_overlap_before_lib_finish_count": overlap_count,
        "result": "stable_cargo_timings_current_build_shows_no_rmeta_unlocked_overlap_and_instead_places_steelsearch_start_at_full_lib_finish_boundary",
    }
