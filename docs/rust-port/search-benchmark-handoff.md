...
- Current coverage summary: `canonical_equal=1770`, `strict_equal=937`,
  `semantic_equal=0`, `failed=0`, `missing=0`,
  `known_gap_or_skipped=22`, `steelsearch_only=359`,
...
- `runtime-stateful-probe`: `519` passed, `0` failed, `0` skipped; `297`
