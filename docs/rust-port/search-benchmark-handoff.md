...
- Current broad-current effective coverage after the ML refresh:
  `canonical_equal=1130`, `strict_equal=842`, `semantic_equal=3`, `failed=0`,
  `missing=0`, `known_gap_or_skipped=0`, `steelsearch_only=6`,
...
- Focused ML report status: `ok`, with `canonical_equal=21`, `failed=0`,
  `missing=0`, and `steelsearch_only=6`.
- Remaining `steelsearch_only=6` breakdown is
  `ml-model-surface=6`. `multi-node-transport-admin` has
