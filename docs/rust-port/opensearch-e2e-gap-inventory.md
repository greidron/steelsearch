...
| REST source statuses | `implemented=150`, `stubbed=4`, `planned=217`, `out-of-scope=18` | Most source-derived rows still need owner-level implementation classification. |
