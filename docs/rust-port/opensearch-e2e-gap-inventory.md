...
| REST source statuses | `implemented=166`, `stubbed=4`, `planned=201`, `out-of-scope=18` | Most source-derived rows still need owner-level implementation classification. |
