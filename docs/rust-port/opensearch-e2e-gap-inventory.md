...
| REST source statuses | `implemented=204`, `stubbed=4`, `planned=163`, `out-of-scope=18` | Most source-derived rows still need owner-level implementation classification. |
