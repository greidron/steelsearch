...
| REST source statuses | `implemented=129`, `stubbed=4`, `planned=238`, `out-of-scope=18` | Most source-derived rows still need owner-level implementation classification. |
