...
| REST source statuses | `implemented=82`, `stubbed=6`, `planned=283`, `out-of-scope=18` | Most source-derived rows still need owner-level implementation classification. |
