...
| REST source statuses | `implemented=272`, `stubbed=4`, `planned=95`, `out-of-scope=18` | Most source-derived rows still need owner-level implementation classification. |
