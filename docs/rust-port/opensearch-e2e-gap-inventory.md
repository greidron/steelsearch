...
| REST source statuses | `implemented=47`, `stubbed=6`, `planned=318`, `out-of-scope=18` | Most source-derived rows still need owner-level implementation classification. |
