...
| REST source statuses | `implemented=13`, `stubbed=6`, `planned=352`, `out-of-scope=18` | Most source-derived rows still need owner-level implementation classification. |
