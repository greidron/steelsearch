...
| REST source statuses | `implemented=103`, `stubbed=4`, `planned=264`, `out-of-scope=18` | Most source-derived rows still need owner-level implementation classification. |
