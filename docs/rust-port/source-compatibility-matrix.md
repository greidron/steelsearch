...
| Core `ActionModule` transport actions | Partial | Partial | 39 core action rows are implemented and the remaining 109 core rows have explicit fail-closed transport boundaries; most server-side execution semantics remain partial. |
