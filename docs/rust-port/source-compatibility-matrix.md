...
| Snapshot and restore | Implemented | Implemented | Implemented | Yes | Snapshot parity is promoted through repository/create/restore/cleanup evidence, restore safety failures, and required migration/cutover linkage. | [snapshot-and-restore](/home/ubuntu/steelsearch/docs/rust-port/replacement-claim-exit-criteria.md#area-snapshot-and-restore) |
