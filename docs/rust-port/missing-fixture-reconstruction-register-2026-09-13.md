...
| --- | --- | --- |
| `target/core-replacement-c05/bool-minimum-compat.json` | Unavailable. The documented original had 10 boundary inputs, positive/negative variants, 1/3 shards, and hit/score/total/count/value-count assertions. | `tools/fixtures/search-bool-minimum-replacement-compat.json` covers documented numeric boundaries 0..4, exclusion, 1/3 shards, search scores/totals, count, and value-count aggregation. It is generated by `tools/generate-bool-minimum-replacement-fixture.py` and is not an original recovery. |
