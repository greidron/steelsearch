...
The failed count moved from 53 to 25:

- `search-compat`: 139 passed, 12 failed, 16 skipped.
- `search-strict`: 132 passed, 13 failed, 6 skipped.
- Unified classification: 139 canonical equal, 132 strict equal,
  22 known gap or skipped, 25 failed.

The remaining 25 failures are not explained by the fixed setup issues. They are
