...
- The same runner now has a `source-backed-query` batch. It passed on
  2026-06-17 with 36/36 tests and `zero_tests=0`, covering native execution,
...
- `nested` exact scalar, range, exists, and string prefix leaves: child ordinal
  indexes now narrow term/terms/range/exists/prefix and supported bool nested
