...
- The same runner now has a `production-security` batch. It passed on
  2026-06-17 with 17/17 tests and `zero_tests=0`, covering runtime env user,
  ...
  stored script management routes, and task cancel/rethrottle surfaces, and
...
- `tools/run-native-closure-validation.py --batch production-security` must
  ...
  routes, and stored script management routes, bounded security audit event
