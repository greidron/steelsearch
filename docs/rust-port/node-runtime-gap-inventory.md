...
- `tools/run-native-closure-validation.py --batch runtime-backpressure` passed
  on 2026-06-17 with 3/3 tests and `zero_tests=0`, covering administrative
...
- extend queue/backpressure smoke tests from bounded search/write saturation
  rejection into broader queued-work, drain, and concurrency behavior;
