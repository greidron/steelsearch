...
delete_pit_request_encode iterations=400000 elapsed_ms=327.484 ops_per_second=1221433.72 nanos_per_op=818.71
delete_pit_request_decode iterations=400000 elapsed_ms=317.667 ops_per_second=1259179.46 nanos_per_op=794.17
delete_pit_request_validate iterations=400000 elapsed_ms=317.501 ops_per_second=1259840.51 nanos_per_op=793.75
delete_pit_response_encode iterations=400000 elapsed_ms=161.419 ops_per_second=2478022.43 nanos_per_op=403.55
delete_pit_response_decode iterations=400000 elapsed_ms=150.957 ops_per_second=2649762.95 nanos_per_op=377.39
delete_pit_wire_bottleneck_ops_per_second=1221433.72
```
...
create_pit_request_encode iterations=400000 elapsed_ms=274.767 ops_per_second=1455777.75 nanos_per_op=686.92
create_pit_request_decode iterations=400000 elapsed_ms=262.929 ops_per_second=1521323.80 nanos_per_op=657.32
create_pit_request_validate iterations=400000 elapsed_ms=263.266 ops_per_second=1519377.53 nanos_per_op=658.16
create_pit_response_encode iterations=400000 elapsed_ms=120.421 ops_per_second=3321679.03 nanos_per_op=301.05
create_pit_response_decode iterations=400000 elapsed_ms=101.251 ops_per_second=3950579.63 nanos_per_op=253.13
create_pit_wire_bottleneck_ops_per_second=1455777.75
```
...
lifecycle subset. Runtime create-PIT now also resolves index/alias/wildcard
targets with OpenSearch-style index option guards, applies routing filters, and
captures the shared SteelNode document snapshot while accepting create-PIT
preference and partial-creation flags for the local all-success shard subset;
the first performance point to inspect while expanding the runtime path is lock
hold time and snapshot allocation around larger document sets.

Current PIT-segments wire microbenchmark:

```text
cargo run -p os-transport --release --bin pit-segments-wire-benchmark
pit_segments_request_encode iterations=400000 elapsed_ms=269.534 ops_per_second=1484044.98 nanos_per_op=673.83
pit_segments_request_decode iterations=400000 elapsed_ms=294.470 ops_per_second=1358374.12 nanos_per_op=736.17
pit_segments_request_validate iterations=400000 elapsed_ms=294.573 ops_per_second=1357896.93 nanos_per_op=736.43
pit_segments_response_encode iterations=400000 elapsed_ms=92.950 ops_per_second=4303379.38 nanos_per_op=232.38
pit_segments_response_decode iterations=400000 elapsed_ms=95.726 ops_per_second=4178589.92 nanos_per_op=239.32
pit_segments_wire_bottleneck_ops_per_second=1357896.93
```
