...
cases. The search semantic suite now reports 49 passed, 0 failed, and 0 skipped cases, including root and targeted
...
- source REST inventory: 389 total rows, 371 in scope, with 264 `planned`, 4
  `stubbed`, 103 `implemented`, and 18 `out-of-scope` rows;
