...
- [ ] Swagger/runtime route parity backlog (generated from `docs/api-spec/generated/route-evidence-matrix.md` planned+stubbed inventory)
  ...
  - [ ] runtime-backed ledger의 `implemented-read` 항목을 `route-evidence-matrix`/Swagger 상태와 동기화
  - [ ] runtime-backed ledger의 `missing-route` 항목을 family별 구현 우선순위로 재정렬하고 false positive를 제거
  ...
  - [ ] root/cluster/node runtime route parity
    ...
    - [ ] ``/_cat/aliases/{alias}`` (GET) [planned]
    - [ ] ``/_cat/aliases`` (GET) [planned]
    - [ ] ``/_cat/allocation/{nodes}`` (GET) [planned]
    - [ ] ``/_cat/allocation`` (GET) [planned]
    - [ ] ``/_cat/count/{index}`` (GET) [planned]
    - [ ] ``/_cat/count`` (GET) [planned]
    - [ ] ``/_cat/fielddata/{fields}`` (GET) [planned]
    - [ ] ``/_cat/fielddata`` (GET) [planned]
    - [ ] ``/_cat/health`` (GET) [planned]
    - [ ] ``/_cat/indices/{index}`` (GET) [planned]
    - [ ] ``/_cat/indices`` (GET) [planned]
    - [ ] ``/_cat/nodeattrs`` (GET) [planned]
    - [ ] ``/_cat/nodes`` (GET) [planned]
    - [ ] ``/_cat/pending_tasks`` (GET) [planned]
    - [ ] ``/_cat/pit_segments/_all`` (GET) [planned]
    - [ ] ``/_cat/pit_segments`` (GET) [planned]
    - [ ] ``/_cat/plugins`` (GET) [planned]
    - [ ] ``/_cat/recovery/{index}`` (GET) [planned]
    - [ ] ``/_cat/recovery`` (GET) [planned]
    - [ ] ``/_cat/repositories`` (GET) [planned]
    - [ ] ``/_cat/segments/{index}`` (GET) [planned]
    - [ ] ``/_cat/segments`` (GET) [planned]
    - [ ] ``/_cat/shards/{index}`` (GET) [planned]
    - [ ] ``/_cat/shards`` (GET) [planned]
    - [ ] ``/_cat/snapshots/{repository}`` (GET) [planned]
    - [ ] ``/_cat/snapshots`` (GET) [planned]
    - [ ] ``/_cat/tasks`` (GET) [planned]
    - [ ] ``/_cat/templates/{name}`` (GET) [planned]
    - [ ] ``/_cat/templates`` (GET) [planned]
    - [ ] ``/_cat/thread_pool/{thread_pool_patterns}`` (GET) [planned]
    - [ ] ``/_cat/thread_pool`` (GET) [planned]
    - [ ] ``/_cat`` (GET) [planned]
    - [ ] ``/_cluster/allocation/explain`` (GET, POST) [planned]
    - [ ] ``/_cluster/decommission/awareness/{awareness_attribute_name}/_status`` (GET) [planned]
    - [ ] ``/_cluster/decommission/awareness/{awareness_attribute_name}/{awareness_attribute_value}`` (PUT) [planned]
    - [ ] ``/_cluster/decommission/awareness`` (DELETE) [planned]
    - [ ] ``/_cluster/health/{index}`` (GET) [planned]
    - [ ] ``/_cluster/health`` (GET) [stubbed]
    - [ ] ``/_cluster/pending_tasks`` (GET) [planned]
    - [ ] ``/_cluster/reroute`` (POST) [planned]
    - [ ] ``/_cluster/routing/awareness/weights`` (DELETE) [planned]
    - [ ] ``/_cluster/routing/awareness/{attribute}/weights`` (DELETE, GET, PUT) [planned]
    - [ ] ``/_cluster/settings`` (GET, PUT) [planned]
    - [ ] ``/_cluster/state/{metric}/{indices}`` (GET) [planned]
    - [ ] ``/_cluster/state/{metric}`` (GET) [planned]
    - [ ] ``/_cluster/state`` (GET) [planned]
    - [ ] ``/_cluster/stats/nodes/{nodeId}`` (GET) [planned]
    - [ ] ``/_cluster/stats/{metric}/nodes/{nodeId}`` (GET) [planned]
    - [ ] ``/_cluster/stats/{metric}/{index_metric}/nodes/{nodeId}`` (GET) [planned]
    - [ ] ``/_cluster/stats`` (GET) [planned]
    - [ ] ``/_cluster/voting_config_exclusions`` (DELETE, POST) [planned]
    - [ ] ``/_dangling/{index_uuid}`` (DELETE, POST) [planned]
    - [ ] ``/_dangling`` (GET) [planned]
    - [ ] ``/_filecache/prune`` (POST) [planned]
    - [ ] ``/_nodes/hot_threads`` (GET) [planned]
    - [ ] ``/_nodes/reload_secure_settings`` (POST) [planned]
    - [ ] ``/_nodes/stats/{metric}/{index_metric}`` (GET) [planned]
    - [ ] ``/_nodes/stats/{metric}`` (GET) [planned]
    - [ ] ``/_nodes/stats`` (GET) [planned]
    - [ ] ``/_nodes/usage/{metric}`` (GET) [planned]
    - [ ] ``/_nodes/usage`` (GET) [planned]
    - [ ] ``/_nodes/{nodeId}/hot_threads`` (GET) [planned]
    - [ ] ``/_nodes/{nodeId}/info/{metrics}`` (GET) [planned]
    - [ ] ``/_nodes/{nodeId}/reload_secure_settings`` (POST) [planned]
    - [ ] ``/_nodes/{nodeId}/stats/{metric}/{index_metric}`` (GET) [planned]
    - [ ] ``/_nodes/{nodeId}/stats/{metric}`` (GET) [planned]
    - [ ] ``/_nodes/{nodeId}/stats`` (GET) [planned]
    - [ ] ``/_nodes/{nodeId}/usage/{metric}`` (GET) [planned]
    - [ ] ``/_nodes/{nodeId}/usage`` (GET) [planned]
    - [ ] ``/_nodes/{nodeId}/{metrics}`` (GET) [planned]
    - [ ] ``/_nodes/{nodeId}`` (GET) [planned]
    - [ ] ``/_nodes`` (GET) [planned]
    - [ ] ``/_remote/info`` (GET) [planned]
    - [ ] ``/_remotestore/_restore`` (POST) [planned]
    - [ ] ``/_remotestore/metadata/{index}/{shard_id}`` (GET) [planned]
    - [ ] ``/_remotestore/metadata/{index}`` (GET) [planned]
    - [ ] ``/_remotestore/stats/{index}/{shard_id}`` (GET) [planned]
    - [ ] ``/_remotestore/stats/{index}`` (GET) [planned]
    - [ ] ``/_script_context`` (GET) [planned]
    - [ ] ``/_script_language`` (GET) [planned]
    - [ ] ``/_scripts/{id}/{context}`` (POST, PUT) [planned]
    - [ ] ``/_scripts/{id}`` (DELETE, GET, POST, PUT) [planned]
    - [ ] ``/_search_shards`` (GET, POST) [planned]
    - [ ] ``/_snapshot/_status`` (GET) [planned]
    - [ ] ``/_snapshot/{repository}/_cleanup`` (POST) [planned]
    - [ ] ``/_snapshot/{repository}/_status`` (GET) [planned]
    - [ ] ``/_snapshot/{repository}/_verify`` (POST) [planned]
    - [ ] ``/_snapshot/{repository}/{snapshot}/_clone/{target_snapshot}`` (PUT) [planned]
    - [ ] ``/_snapshot/{repository}/{snapshot}/_restore`` (POST) [planned]
    - [ ] ``/_snapshot/{repository}/{snapshot}/_status`` (GET) [planned]
    - [ ] ``/_snapshot/{repository}/{snapshot}/{index}/_status`` (GET) [planned]
    - [ ] ``/_snapshot/{repository}/{snapshot}`` (DELETE, GET, POST, PUT) [planned]
    - [ ] ``/_snapshot/{repository}`` (DELETE, GET, POST, PUT) [planned]
    - [ ] ``/_snapshot`` (GET) [planned]
    - [ ] ``/_tasks/_cancel`` (POST) [planned]
    - [ ] ``/_tasks/{task_id}/_cancel`` (POST) [planned]
    - [ ] ``/_tasks/{task_id}`` (GET) [planned]
    - [ ] ``/_tasks`` (GET) [planned]
    - [ ] ``/`` (DELETE) [planned]
    - [ ] ``/{index}/_search_shards`` (GET, POST) [planned]
    - [ ] ``_list/wlm_stats/stats/{workloadGroupId}`` (GET) [planned]
    - [ ] ``_list/wlm_stats/{nodeId}/stats/{workloadGroupId}`` (GET) [planned]
    - [ ] ``_list/wlm_stats/{nodeId}/stats`` (GET) [planned]
    - [ ] ``_list/wlm_stats`` (GET) [planned]
    - [ ] ``_wlm/stats/{workloadGroupId}`` (GET) [planned]
    - [ ] ``_wlm/stats`` (GET) [planned]
    - [ ] ``_wlm/{nodeId}/stats/{workloadGroupId}`` (GET) [planned]
    - [ ] ``_wlm/{nodeId}/stats`` (GET) [planned]
  - [ ] index/metadata runtime route parity
    ...
    - [ ] ``/_alias/{name}`` (GET, HEAD, POST, PUT) [planned]
    - [ ] ``/_alias`` (GET, PUT) [planned]
    - [ ] ``/_aliases/{name}`` (POST, PUT) [planned]
    - [ ] ``/_aliases`` (GET, POST) [planned]
    - [ ] ``/_analyze`` (GET, POST) [planned]
    - [ ] ``/_cache/clear`` (POST) [planned]
    - [ ] ``/_close`` (POST) [planned]
    - [ ] ``/_component_template/{name}`` (DELETE, GET, HEAD, POST, PUT) [planned]
    - [ ] ``/_component_template`` (GET) [planned]
    - [ ] ``/_data_stream/_stats`` (GET) [planned]
    - [ ] ``/_data_stream/{name}/_stats`` (GET) [planned]
    - [ ] ``/_data_stream/{name}`` (DELETE, GET, PUT) [planned]
    - [ ] ``/_data_stream`` (GET) [planned]
    - [ ] ``/_flush/synced`` (GET, POST) [planned]
    - [ ] ``/_flush`` (GET, POST) [planned]
    - [ ] ``/_forcemerge`` (POST) [planned]
    - [ ] ``/_index_template/_simulate/{name}`` (POST) [planned]
    - [ ] ``/_index_template/_simulate_index/{name}`` (POST) [planned]
    - [ ] ``/_index_template/_simulate`` (POST) [planned]
    - [ ] ``/_index_template/{name}`` (DELETE, GET, HEAD, POST, PUT) [planned]
    - [ ] ``/_index_template`` (GET) [planned]
    - [ ] ``/_mapping/field/{fields}`` (GET) [planned]
    - [ ] ``/_mapping`` (GET) [planned]
    - [ ] ``/_mappings`` (GET) [planned]
    - [ ] ``/_open`` (POST) [planned]
    - [ ] ``/_recovery`` (GET) [planned]
    - [ ] ``/_resolve/index/{name}`` (GET) [planned]
    - [ ] ``/_segments`` (GET) [planned]
    - [ ] ``/_settings/{name}`` (GET) [planned]
    - [ ] ``/_settings`` (GET, PUT) [planned]
    - [ ] ``/_shard_stores`` (GET) [planned]
    - [ ] ``/_stats/{metric}`` (GET) [planned]
    - [ ] ``/_stats`` (GET) [planned]
    - [ ] ``/_template/{name}`` (DELETE, GET, HEAD, POST, PUT) [planned]
    - [ ] ``/_template`` (GET) [planned]
    - [ ] ``/_upgrade`` (GET, POST) [planned]
    - [ ] ``/{index}/_alias/{name}`` (DELETE, GET, HEAD, POST, PUT) [planned]
    - [ ] ``/{index}/_alias`` (GET, HEAD, PUT) [planned]
    - [ ] ``/{index}/_aliases/{name}`` (DELETE, POST, PUT) [planned]
    - [ ] ``/{index}/_aliases`` (PUT) [planned]
    - [ ] ``/{index}/_analyze`` (GET, POST) [planned]
    - [ ] ``/{index}/_block/{block}`` (PUT) [planned]
    - [ ] ``/{index}/_cache/clear`` (POST) [planned]
    - [ ] ``/{index}/_clone/{target}`` (POST, PUT) [planned]
    - [ ] ``/{index}/_close`` (POST) [planned]
    - [ ] ``/{index}/_flush/synced`` (GET, POST) [planned]
    - [ ] ``/{index}/_flush`` (GET, POST) [planned]
    - [ ] ``/{index}/_forcemerge`` (POST) [planned]
    - [ ] ``/{index}/_mapping/field/{fields}`` (GET) [planned]
    - [ ] ``/{index}/_mapping`` (GET, POST, PUT) [planned]
    - [ ] ``/{index}/_mappings`` (GET, POST, PUT) [planned]
    - [ ] ``/{index}/_open`` (POST) [planned]
    - [ ] ``/{index}/_recovery`` (GET) [planned]
    - [ ] ``/{index}/_rollover/{new_index}`` (POST) [planned]
    - [ ] ``/{index}/_rollover`` (POST) [planned]
    - [ ] ``/{index}/_scale`` (POST) [planned]
    - [ ] ``/{index}/_segments`` (GET) [planned]
    - [ ] ``/{index}/_setting/{name}`` (GET) [planned]
    - [ ] ``/{index}/_settings/{name}`` (GET) [planned]
    - [ ] ``/{index}/_settings`` (GET, PUT) [planned]
    - [ ] ``/{index}/_shard_stores`` (GET) [planned]
    - [ ] ``/{index}/_shrink/{target}`` (POST, PUT) [planned]
    - [ ] ``/{index}/_split/{target}`` (POST, PUT) [planned]
    - [ ] ``/{index}/_stats/{metric}`` (GET) [planned]
    - [ ] ``/{index}/_stats`` (GET) [planned]
    - [ ] ``/{index}/_upgrade`` (GET, POST) [planned]
    - [ ] ``/{index}/ingestion/_pause`` (POST) [planned]
    - [ ] ``/{index}/ingestion/_resume`` (POST) [planned]
    - [ ] ``/{index}/ingestion/_state`` (GET) [planned]
    - [ ] ``/{index}`` (DELETE, GET, HEAD, PUT) [stubbed]
  - [ ] document/bulk runtime route parity
    ...
    - [ ] ``/_bulk/stream`` (POST, PUT) [planned]
    - [ ] ``/_bulk`` (POST, PUT) [planned]
    - [ ] ``/_delete_by_query/{taskId}/_rethrottle`` (POST) [planned]
    - [ ] ``/_mget`` (GET, POST) [planned]
    - [ ] ``/_mtermvectors`` (GET, POST) [planned]
    - [ ] ``/_refresh`` (GET, POST) [planned]
    - [ ] ``/_reindex/{taskId}/_rethrottle`` (POST) [planned]
    - [ ] ``/_reindex`` (POST) [planned]
    - [ ] ``/_update_by_query/{taskId}/_rethrottle`` (POST) [planned]
    - [ ] ``/{index}/_bulk/stream`` (POST, PUT) [planned]
    - [ ] ``/{index}/_bulk`` (POST, PUT) [planned]
    - [ ] ``/{index}/_create/{id}`` (POST, PUT) [planned]
    - [ ] ``/{index}/_delete_by_query`` (POST) [planned]
    - [ ] ``/{index}/_doc/{id}`` (DELETE, GET, HEAD, POST, PUT) [stubbed]
    - [ ] ``/{index}/_doc`` (POST) [planned]
    - [ ] ``/{index}/_mget`` (GET, POST) [planned]
    - [ ] ``/{index}/_mtermvectors`` (GET, POST) [planned]
    - [ ] ``/{index}/_refresh`` (GET, POST) [planned]
    - [ ] ``/{index}/_source/{id}`` (GET, HEAD) [planned]
    - [ ] ``/{index}/_termvectors/{id}`` (GET, POST) [planned]
    - [ ] ``/{index}/_termvectors`` (GET, POST) [planned]
    - [ ] ``/{index}/_update/{id}`` (POST) [planned]
    - [ ] ``/{index}/_update_by_query`` (POST) [planned]
  - [ ] search runtime route parity
    ...
    - [ ] ``/ + ENDPOINT`` (GET, POST) [planned]
    - [ ] ``/_count`` (GET, POST) [planned]
    - [ ] ``/_msearch/template`` (GET, POST) [planned]
    - [ ] ``/_msearch`` (GET, POST) [planned]
    - [ ] ``/_render/template/{id}`` (GET, POST) [planned]
    - [ ] ``/_render/template`` (GET, POST) [planned]
    - [ ] ``/_search/pipeline/{id}`` (DELETE, GET, PUT) [planned]
    - [ ] ``/_search/pipeline`` (GET) [planned]
    - [ ] ``/_search/point_in_time/_all`` (DELETE, GET) [planned]
    - [ ] ``/_search/point_in_time`` (DELETE) [planned]
    - [ ] ``/_search/scroll/{scroll_id}`` (DELETE, GET, POST) [planned]
    - [ ] ``/_search/scroll`` (DELETE, GET, POST) [planned]
    - [ ] ``/_search/template`` (GET, POST) [planned]
    - [ ] ``/_search`` (GET, POST) [planned]
    - [ ] ``/_validate/query`` (GET, POST) [planned]
    - [ ] ``/{index}/ + ENDPOINT`` (GET, POST) [planned]
    - [ ] ``/{index}/_count`` (GET, POST) [planned]
    - [ ] ``/{index}/_explain/{id}`` (GET, POST) [planned]
    - [ ] ``/{index}/_msearch/template`` (GET, POST) [planned]
    - [ ] ``/{index}/_msearch`` (GET, POST) [planned]
    - [ ] ``/{index}/_search/point_in_time`` (POST) [planned]
    - [ ] ``/{index}/_search/template`` (GET, POST) [planned]
    - [ ] ``/{index}/_search`` (GET, POST) [planned]
    - [ ] ``/{index}/_validate/query`` (GET, POST) [planned]
  - [ ] snapshot/migration helper runtime route parity
    ...
    - [ ] ``/_ingest/pipeline/_simulate`` (GET, POST) [planned]
    - [ ] ``/_ingest/pipeline/{id}/_simulate`` (GET, POST) [planned]
    - [ ] ``/_ingest/pipeline/{id}`` (DELETE, GET, PUT) [planned]
    - [ ] ``/_ingest/pipeline`` (GET) [planned]
    - [ ] ``/_ingest/processor/grok`` (GET) [planned]
    - [ ] ``/_scripts/painless/_context`` (GET) [planned]
    - [ ] ``/_scripts/painless/_execute`` (GET, POST) [planned]
  - [ ] vector/ML runtime route parity
    ...
    - [ ] ``KNNPlugin.KNN_BASE_URI + "/stats/"`` (GET) [planned]
    - [ ] ``KNNPlugin.KNN_BASE_URI + "/stats/{stat}"`` (GET) [planned]
    - [ ] ``KNNPlugin.KNN_BASE_URI + "/{nodeId}/stats/"`` (GET) [planned]
    - [ ] ``KNNPlugin.KNN_BASE_URI + "/{nodeId}/stats/{stat}"`` (GET) [planned]
    - [ ] ``KNNPlugin.KNN_BASE_URI + URL_PATH`` (GET) [planned]
    - [ ] ``String.format(Locale.ROOT, "%s/%s/%s", KNNPlugin.KNN_BASE_URI, MODELS, SEARCH)`` (GET, POST) [planned]
    - [ ] ``String.format(Locale.ROOT, "%s/%s/_train", KNNPlugin.KNN_BASE_URI, MODELS)`` (POST) [planned]
    - [ ] ``String.format(Locale.ROOT, "%s/%s/{%s}", KNNPlugin.KNN_BASE_URI, CLEAR_CACHE, INDEX)`` (POST) [planned]
    - [ ] ``String.format(Locale.ROOT, "%s/%s/{%s}", KNNPlugin.KNN_BASE_URI, MODELS, MODEL_ID)`` (DELETE, GET) [planned]
    - [ ] ``String.format(Locale.ROOT, "%s/%s/{%s}/_train", KNNPlugin.KNN_BASE_URI, MODELS, MODEL_ID)`` (POST) [planned]
  - [ ] misc runtime route parity
    ...
    - [ ] ``/_field_caps`` (GET, POST) [planned]
    - [ ] ``/_list/indices/{index}`` (GET) [planned]
    - [ ] ``/_list/indices`` (GET) [planned]
    - [ ] ``/_list/shards/{index}`` (GET) [planned]
    - [ ] ``/_list/shards`` (GET) [planned]
    - [ ] ``/_list`` (GET) [planned]
    - [ ] ``/_opensearch_dashboards + route.getPath(`` ((dynamic)) [planned]
    - [ ] ``/_tier/_cancel/{index}`` (POST) [planned]
    - [ ] ``/_tier/all`` (GET) [planned]
    - [ ] ``/{index}/_field_caps`` (GET, POST) [planned]
    - [ ] ``/{index}/_tier/ + targetTier`` (POST) [planned]
    - [ ] ``/{index}/_tier`` (GET) [planned]
