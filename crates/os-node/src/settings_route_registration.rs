...
pub const SETTINGS_ROUTE_REGISTRY_TABLE: [SettingsRouteRegistryEntry; 3] = [
...
mod tests {
    ...
    fn settings_registry_table_describes_global_and_index_scoped_routes() {
        assert_eq!(SETTINGS_ROUTE_REGISTRY_TABLE.len(), 3);
        assert_eq!(SETTINGS_ROUTE_REGISTRY_TABLE[0].path, "/_settings");
        assert_eq!(SETTINGS_ROUTE_REGISTRY_TABLE[1].path, "/{index}/_settings");
        assert_eq!(SETTINGS_ROUTE_REGISTRY_TABLE[2].method, "PUT");
    }
