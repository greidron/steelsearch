...
mod tests {
    ...
    fn parses_intervals_queries() {
        ...
        let regexp_flags = parse_query(&serde_json::json!({
            "intervals": {
                "message": {
                    "regexp": {
                        "pattern": "pay.*",
        ...
        let regexp_flags_value = parse_query(&serde_json::json!({
            "intervals": {
                "message": {
                    "regexp": {
                        "pattern": "payment",
    ...
    fn parses_moving_fn_sum_min_max_pipeline_aggregations() {
        ...
        assert_eq!(
            ...
            Aggregation::Pipeline(PipelineAggregation {
                kind: PipelineAggregationKind::MovingStddevFn,
                buckets_path: "by_service>_count".to_string(),
                window: Some(2),
                percents: None,
                values: None,
