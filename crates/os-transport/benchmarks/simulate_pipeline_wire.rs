...
use os_transport::action::{
    build_opensearch_simulate_pipeline_request_message,
    build_opensearch_simulate_pipeline_response_message,
    read_opensearch_simulate_pipeline_request_message,
    read_opensearch_simulate_pipeline_response_message, OpenSearchSimulatePipelineRequestWire,
    OpenSearchSimulatePipelineResponseWire,
};
...
fn main() {
    ...
    let response_frame = build_opensearch_simulate_pipeline_response_message(
        77,
        OPENSEARCH_3_7_0_TRANSPORT,
        &response,
    )
